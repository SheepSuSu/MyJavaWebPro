...
<%@ page import="cake.wx.shopping.vo.Admin" %>
<%
...
<html>
  <head>
    ...
    <title>Administrator.jsp starting page</title>
    <style>
      .welcome-text {
        font-size: 20px;
        font-weight: bold;
...
<table width="100%" height="519" border="0" cellpadding="1" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="413" height="266" border="0" cellpadding="1">
      <tr>
        <td background="images/admin_login_bg.jpg"><form action="servlet/AdminServlet?actionType=0" method="post">
          <table width="400" height="243" border="0" cellpadding="1">
            ...
            <tr>
              <td colspan="4" align="center" class="welcome-text">欢迎登录后台管理系统</td>
            </tr>
            <tr>
              <td height="55">&nbsp;</td>
              <td>&nbsp;</td>
